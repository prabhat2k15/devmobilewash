...
require_once 'Twilio/Resource.php';
require_once 'Twilio/TinyHttp.php';
require_once 'Twilio/RestException.php';
require_once 'Twilio/AccessToken.php';
require_once 'Twilio/AutoPagingIterator.php';
require_once 'Twilio/Capability.php';
require_once 'Twilio/CapabilityAPI.php';
require_once 'Twilio/CapabilityTaskRouter.php';
require_once 'Twilio/HttpException.php';
require_once 'Twilio/HttpStream.php';
require_once 'Twilio/InstanceResource.php';
require_once 'Twilio/ListResource.php';
require_once 'Twilio/NumberType.php';
require_once 'Twilio/UsageResource.php';
require_once 'Twilio/TimeRangeResource.php';
require_once 'Twilio/SIPListResource.php';




require_once 'Twilio/Rest/Account.php';
require_once 'Twilio/Rest/Accounts.php';
require_once 'Twilio/Rest/Application.php';
require_once 'Twilio/Rest/Applications.php';
require_once 'Twilio/Rest/AvailablePhoneNumber.php';
require_once 'Twilio/Rest/AvailablePhoneNumbers.php';
require_once 'Twilio/Rest/OutgoingCallerId.php';
require_once 'Twilio/Rest/OutgoingCallerIds.php';
require_once 'Twilio/Rest/Call.php';
require_once 'Twilio/Rest/Calls.php';
require_once 'Twilio/Rest/Feedback.php';
require_once 'Twilio/Rest/FeedbackSummary.php';
require_once 'Twilio/Rest/Conference.php';
require_once 'Twilio/Rest/Conferences.php';
require_once 'Twilio/Rest/IncomingPhoneNumber.php';
require_once 'Twilio/Rest/IncomingPhoneNumbers.php';
require_once 'Twilio/Rest/Key.php';
require_once 'Twilio/Rest/Keys.php';
require_once 'Twilio/Rest/Media.php';
require_once 'Twilio/Rest/Message.php';
require_once 'Twilio/Rest/Messages.php';
require_once 'Twilio/Rest/Notifications.php';
require_once 'Twilio/Rest/IncomingPhoneNumber.php';
require_once 'Twilio/Rest/Recording.php';
require_once 'Twilio/Rest/Recordings.php';
require_once 'Twilio/Rest/SmsMessage.php';
require_once 'Twilio/Rest/SmsMessages.php';
require_once 'Twilio/Rest/ShortCode.php';
require_once 'Twilio/Rest/ShortCodes.php';
require_once 'Twilio/Rest/Token.php';
require_once 'Twilio/Rest/Tokens.php';
require_once 'Twilio/Rest/Transcription.php';
require_once 'Twilio/Rest/Transcriptions.php';
require_once 'Twilio/Rest/ConnectApp.php';
require_once 'Twilio/Rest/ConnectApps.php';
require_once 'Twilio/Rest/AuthorizedConnectApp.php';
require_once 'Twilio/Rest/AuthorizedConnectApps.php';
require_once 'Twilio/Rest/UsageRecord.php';
require_once 'Twilio/Rest/UsageRecords.php';
require_once 'Twilio/Rest/UsageTrigger.php';
require_once 'Twilio/Rest/UsageTriggers.php';
require_once 'Twilio/Rest/Queue.php';
require_once 'Twilio/Rest/Queues.php';
require_once 'Twilio/Rest/Sip.php';
require_once 'Twilio/Rest/Domain.php';
require_once 'Twilio/Rest/Domains.php';
require_once 'Twilio/Rest/IpAccessControlList.php';
require_once 'Twilio/Rest/IpAccessControlLists.php';
require_once 'Twilio/Rest/CredentialList.php';
require_once 'Twilio/Rest/CredentialLists.php';
require_once 'Twilio/Rest/Address.php';
require_once 'Twilio/Rest/Addresses.php';
require_once 'Twilio/Rest/Sandbox.php';
...
require_once 'Twilio/NextGenListResource.php';
require_once 'Twilio/NextGenInstanceResource.php';

require_once 'Twilio/IPMessagingInstanceResource.php';
require_once 'Twilio/IPMessagingListResource.php';
require_once 'Twilio/JWT.php';
require_once 'Twilio/ListResource.php';
require_once 'Twilio/LookupsInstanceResource.php';
require_once 'Twilio/LookupsListResource.php';
require_once 'Twilio/MonitorInstanceResource.php';
require_once 'Twilio/MonitorListResource.php';
require_once 'Twilio/NumberType.php';
require_once 'Twilio/Page.php';
require_once 'Twilio/PartialApplicationHelper.php';
require_once 'Twilio/PricingInstanceResource.php';
require_once 'Twilio/PricingListResource.php';
require_once 'Twilio/RequestValidator.php';
require_once 'Twilio/SIPListResource.php';
require_once 'Twilio/TaskRouterInstanceResource.php';
require_once 'Twilio/TaskRouterListResource.php';
require_once 'Twilio/TimeRangeResource.php';
require_once 'Twilio/TrunkingInstanceResource.php';
require_once 'Twilio/TrunkingListResource.php';
