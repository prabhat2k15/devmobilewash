...
<div style='margin-top: 20px;'>
               ...
               <a href='https://plus.google.com/114985712775567009759/about'><img style='margin-left: 2px;' src='https://www.mobilewash.com/images/gp.png' alt=''></a>
                ...
                <img src='https://www.mobilewash.com/images/home-banner.jpg' style='width: 100%;' />
                <div style='background: #eeeeee; padding: 20px; font-size: 16px; font-family: arial, sans-serif; line-height: 26px;'>
               <?php echo $content; ?>
                </div>
</div>
<p style='text-align: center; font-size: 14px; font-family: arial, sans-serif; line-height: 20px; width: 480px; margin: 12px auto; padding-bottom: 25px;'>&copy; <?php echo date("Y"); ?> MobileWash, Inc. All rights reserved. All trademarks referenced herein are the property of their respective owners.</p>
</div>
