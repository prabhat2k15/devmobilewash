...
$data = array('wash_request_id' => $_GET['orderid'], 'key' => API_KEY, 'coupon_discount' => 0, 'api_password' => '', 'api_token' => $_GET['api_token'], 't1' => $_GET['t1'], 't2' => $_GET['t2'], 'user_type' => $_GET['user_type'], 'user_id' => $_GET['user_id']);
...
<html>
    ...
    <body>
        ...
        <div class="content">
            <?php if ($kartdata->is_scheduled > 0): ?>
            ...
            <?php if (($kartdata->status == 5) || ($kartdata->status == 7)): ?>
                ...
                <table class="discount-details">
                    <tr>
                        <td><p style="font-size: 20px;"><?php
                                if ($kartdata->status == 7) {
                                    echo "CNR Fee";
                                } else {
                                    echo "Cancel Fee";
                                }
                        ...
                        <td class="rightalign">
                            <p class="price">$<?php
                                if ($kartdata->washer_cancel_fee > 0) {
                                    echo number_format($kartdata->washer_cancel_fee, 2);
                                } else {
                                    echo '0.00';
                                }
                                ?></p>
                ...
                <table class="total">
                    <tr>
                        ...
                        <td class="rightalign"><p class="total-price">$<?php
                                if ($kartdata->washer_cancel_fee > 0) {
                                    echo number_format($kartdata->washer_cancel_fee, 2);
                                } else {
                                    echo '0.00';
                                ...
                                <table class="inline-table">
                                    ...
                                    <?php if ($vehicle->surge_vehicle_fee > 0): ?>
                                        <tr>
                                            ...
                                            <td class="rightalign"><p>+$<?php
                                                    $surge_fee = $vehicle->surge_vehicle_fee * .8;
                                                    echo number_format(round($surge_fee, 2), 2);
                                                    ?></p></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if ($vehicle->extclaybar_vehicle_fee > 0): ?>
                                        <tr>
                                            ...
                                            <td class="rightalign"><p>+$<?php
                                                    $extclaybar_fee = $vehicle->extclaybar_vehicle_fee * .8;
                                                    echo number_format(round($extclaybar_fee, 2), 2);
                                                    ?></p></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if ($vehicle->waterspotremove_vehicle_fee > 0): ?>
                                        <tr>
                                            ...
                                            <td class="rightalign"><p>+$<?php
                                                    $waterspotremove_fee = $vehicle->waterspotremove_vehicle_fee * .8;
                                                    echo number_format(round($waterspotremove_fee, 2), 2);
                                                    ?></p></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if ($vehicle->upholstery_vehicle_fee > 0): ?>
                                        <tr>
                                            ...
                                            <td class="rightalign"><p>+$<?php
                                                    $upholstery_fee = $vehicle->upholstery_vehicle_fee * .8;
                                                    echo number_format(round($upholstery_fee, 2), 2);
                                                    ?></p></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if ($vehicle->exthandwax_vehicle_fee > 0): ?>
                                        <tr>
                                            ...
                                            <td class="rightalign"><p>+$<?php
                                                    $exthandwax_fee = $vehicle->exthandwax_vehicle_fee * .8;
                                                    echo number_format(round($exthandwax_fee, 2), 2);
                                                    ?></p></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if ($vehicle->floormat_vehicle_fee > 0): ?>
                                        <tr>
                                            ...
                                            <td class="rightalign"><p>+$<?php
                                                    $floormat_fee = $vehicle->floormat_vehicle_fee * .8;
                                                    echo number_format(round($floormat_fee, 2), 2);
                                                    ?></p></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if ($vehicle->pet_hair_fee > 0): ?>
                                        <tr>
                                            ...
                                            <td class="rightalign"><p>+$<?php
                                                    $pet_fee = $vehicle->pet_hair_fee * .8;
                                                    echo number_format(round($pet_fee, 2), 2);
                                                    ?></p></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if ($vehicle->lifted_vehicle_fee > 0): ?>
                                        <tr>
                                            ...
                                            <td class="rightalign"><p>+$<?php
                                                    $lift_fee = $vehicle->lifted_vehicle_fee * .8;
                                                    echo number_format(round($lift_fee, 2), 2);
                                                    ?></p></td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php if ($vehicle->extplasticdressing_vehicle_fee > 0): ?>
                                        <tr>
                                            ...
                                            <td class="rightalign"><p>+$<?php
                                                    $extplasticdressing_fee = $vehicle->extplasticdressing_vehicle_fee * .8;
                                                    echo number_format(round($extplasticdressing_fee, 2), 2);
                                                    ?></p></td>
                                        </tr>
                                    <?php endif; ?>
