...
<?php endif; ?>
<?php
    $url = 'http://www.devmobilewash.com/api/index.php?r=PhoneOrders/getallorders';
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"> Call-In Orders</span> <a href="add-schedule-order.php" style="margin-left: 15px; font-size: 16px; font-weight: bold;">+ Add New Order</a>
                                    </div>
                                    <div class="caption font-dark">
...
<?php endif; ?>
                ...
                <tr class="odd gradeX">
					<td><a href="edit-phone-order.php?id=<?php echo $order->id; ?>" style="margin-right: 7px;">Edit</a> <?php if(!$order->is_cancel): ?><a href="#" class="delete-order" data-id="<?php echo $order->id; ?>">Cancel</a><?php endif; ?></td>
...
<?php endif; ?>
                    ...
                    <td><?php
						if(!$order->regular_vehicles) echo "N/A";
						else{
                   ...
                   <td><?php
						if(!$order->classic_vehicles) echo "N/A";
						else{
