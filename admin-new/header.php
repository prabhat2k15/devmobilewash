...
$recruiter_permit_pages = array('index.php', 'all-orders.php', 'vehicles-packages.php', 'order_calendar.php', 'manage-pre-clients.php', 'client_dashboard.php', 'washer_dashboard.php', 'pre-clients-details.php', 'edit-customer.php', 'manage-customers.php', 'manage-pre-washers.php', 'add-new-bug.php', 'top-washers.php', 'top-customers.php', 'mobilewasher-service-feedbacks.php', 'command-center.php', 'search.php');
