<?php 
    if($_GET['action'] == 'trash'){
        $clientsid = $_GET['id'];
        $url = 'http://www.devmobilewash.com/api/index.php?r=customers/trashpreclients2&id='.$clientsid;
        ...
        if($response == "clients trashed" && $result_code == "true"){
            ?>
            <script type="text/javascript">window.location = "http://www.devmobilewash.com/admin-new/manage-pre-clients2.php?trash=true"</script>
            <?php
            die();
            }
    }
    if($_GET['action'] == 'aprove'){
        $clientsid = $_GET['id'];
        $url = 'http://www.devmobilewash.com/api/index.php?r=customers/approveclients&id='.$clientsid;
        $handle = curl_init($url);
        $data = array('key' => 'Tva4hwH9KvqEQHTz5nHZTLhAV7Bv68AAtBeAHMA4');
        curl_setopt($handle, CURLOPT_POST, true);
        curl_setopt($handle, CURLOPT_POSTFIELDS, $data);
        ...
        if($response == "clients approved" && $result_code == "true"){
            ?>
            <script type="text/javascript">window.location = "http://www.devmobilewash.com/admin-new/active-washers.php?aprove=true"</script>
            <?php
            die();
            }
    }
    if($_GET['action'] == 'disaprove'){
        $clientsid = $_GET['id'];
        $url = 'http://www.devmobilewash.com/api/index.php?r=customers/disapproveclients&id='.$clientsid;
        $handle = curl_init($url);
        $data = array('key' => 'Tva4hwH9KvqEQHTz5nHZTLhAV7Bv68AAtBeAHMA4');
        curl_setopt($handle, CURLOPT_POST, true);
        curl_setopt($handle, CURLOPT_POSTFIELDS, $data);
        ...
        if($response == "clients disapproved" && $result_code == "true"){
            ?>
            <script type="text/javascript">window.location = "http://www.devmobilewash.com/admin-new/active-washers.php?disaprove=true"</script>
            <?php
            die();
            }
    }
...
<?php endif; ?>
<?php
     $url = 'http://www.devmobilewash.com/api/index.php?r=customers/getallpreclients2'; 
            $handle = curl_init($url);
            $data = array('key' => 'Tva4hwH9KvqEQHTz5nHZTLhAV7Bv68AAtBeAHMA4');
            curl_setopt($handle, CURLOPT_POST, true);
            curl_setopt($handle, CURLOPT_POSTFIELDS, $data);
            ...
            $url_trash = 'http://www.devmobilewash.com/api/index.php?r=customers/getpreclientstrashdata2'; 
