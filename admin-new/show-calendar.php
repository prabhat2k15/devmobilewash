...
<script>
    ...
    function refreshCal() {
        ...
        timetracker += 10;
        if (timetracker >= 120)
            window.location.href = "<?php echo ROOT_URL; ?>/admin-new/show-calendar.php";
...
//setTimeout( refreshCal, 10000 );
    ...
    $(document).ready(function () {
        ...
        $('.csv-link').attr('href', "<?php echo ROOT_URL; ?>/api/index.php?r=site/testingcsv&key=<?php echo API_KEY; ?>&start_month=" + end_month + "&end_month=" + end_month + "&api_token=<?php echo urlencode($finalusertoken); ?>&t1=<?php echo urlencode($mw_admin_auth_arr[2]); ?>&t2=<?php echo urlencode($mw_admin_auth_arr[3]); ?>&user_type=admin&user_id=<?php echo urlencode($mw_admin_auth_arr[4]); ?>");
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <input type="hidden" id="start_month" value="" />
        <input type="hidden" id="end_month" value="" />
