...
<?php
    ...
    $url = 'http://www.devmobilewash.com/api/index.php?r=PhoneOrders/view_agent_wash';

    $handle = curl_init($url);
	$data = array('agent_id' => $agent_id, 'key' => 'Tva4hwH9KvqEQHTz5nHZTLhAV7Bv68AAtBeAHMA4');	
...
$washer_all_orders = $jsondata->orders;
/* echo"<pre>";print_r($washer_all_orders);echo"</pre>"; */
?>
<style>
.label-complete {
...
<!-- BEGIN CONTENT -->
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                   ...
                   <?php foreach($washer_all_orders as $order){ 
