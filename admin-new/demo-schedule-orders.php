                        ...
                        <?php if ($s_orders_result_code == 'true') { ?>
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="example1">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    foreach ($s_mw_all_orders as $order) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?php
                                                    if (count($order->agent_details))
                                                        echo $order->agent_details->agent_id;
                                                    else
                                                        echo "N/A";
                                                    ?>
                                                </td>
                                                <td><?php
                                                    if (count($order->agent_details))
                                                        echo $order->agent_details->agent_name;
                                                    else
                                                        echo "N/A";
                                                    ?>
                                                </td>
                                                <td><?php
                                                    if (count($order->agent_details))
                                                        echo $order->agent_details->agent_email;
                                                    else
                                                        echo "N/A";
                                                    ?>
                                                </td>
                                                ...
                                                <td><?php
                                                    ...
                                                    ?></td>
                                                <td><?php
                                                    if ($order->schedule_total)
                                                        echo "$" . $order->schedule_total;
                                                    else
                                                        echo "N/A";
                                                    ?></td>
