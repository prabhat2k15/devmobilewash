...
if ($_GET['type'])
    $url = ROOT_URL . '/api/index.php?r=agents/getallagents&type=' . $_GET['type'];
else
    $url = ROOT_URL . '/api/index.php?r=agents/getallagents';
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row" style="background-color: #000; color: #fff; margin-left: -20px ! important; margin-right: -20px;">
            ...
            <div class="col-md-1 col-sm-1" id="care-rating" style="padding: 13px 0px 0px 10px; cursor: pointer;">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        ...
                        <div class="caption font-dark" style="padding: 10px 0px 0px 20px; padding-top: 3px; display: <?php echo $add_washer; ?>">
                            ...
                            <select name="washer-type" class="washer-type" style="margin-left: 15px; font-size: 16px; padding: 5px;">
                                <option value="<?php echo ROOT_URL; ?>/admin-new/manage-agents.php?type=real">Real Washer</option>
                                <option <?php if ($_GET['type'] == 'demo') echo 'selected'; ?> value="<?php echo ROOT_URL; ?>/admin-new/manage-agents.php?type=demo">Demo Washer<option>
                            </select> 
                            <a style="margin-left: 20px;" target="_blank" href="<?php echo ROOT_URL; ?>/api/index.php?r=site/washerscsvexport&key=<?php echo API_KEY; ?>&api_token=<?php echo urlencode($finalusertoken); ?>&t1=<?php echo urlencode($mw_admin_auth_arr[2]); ?>&t2=<?php echo urlencode($mw_admin_auth_arr[3]); ?>&user_type=admin&user_id=<?php echo urlencode($mw_admin_auth_arr[4]); ?>">Download CSV</a>                                    
                        </div>
                        <div class="actions">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th> City </th>
                                    <th class="hide"> Insurance Exp. Date </th>
                                    <th> Rating </th>
                                    <th> CARE Rating </th>
                                    <th> Blocked </th>
                                    <th> Helper </th>
                            ...
                            <tbody>
                                ...
                                foreach ($allagents->all_washers as $washer) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <?php if ($washer->vehicle_pic) { ?>
                                                <img src="<?= $washer->vehicle_pic; ?>" style="width: 100px; height: 100px;" />
                                            <?php } ?>
                                        ...
                                        <td class="hide"> <?php echo $washer->insurance_exp_date; ?> </td>
                                        ...
                                        <td> <?php echo ($washer->helper == '1') ? 'yes' : 'No'; ?> </td>
                                        <td> <?php echo $washer->operate_area; ?> </td>
...
//console.log(alldata);
                    ...
                    $.each(data.all_washers, function (index, value) {
                        ...
                        if ((value.care_rating != "N/A") && (value.care_rating != "NEW"))
                            allwashers.push(value.care_rating + "%");
                        else
                            allwashers.push(value.care_rating);
