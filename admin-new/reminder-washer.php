...
$agent_reminder = array();
foreach($_POST['section-title'] as $ind => $title){
//echo $title."<br>";
$agent_reminder[$ind]['title'] = $title;
}

//echo "<br><br><br>";
foreach($_POST['section-content'] as $ind => $content){
//echo $content."<br>";
$agent_reminder[$ind]['content'] = $content;
}

// print_r($agent_reminder);
$agent_reminder_json_arr = json_encode($agent_reminder);
//echo $agent_reminder_json_arr;


            // COLLECT POST VALUE //

            $data = array('agent_reminder'=> $agent_reminder_json_arr, 'key' => API_KEY, 'api_token' => $finalusertoken, 't1' => $mw_admin_auth_arr[2], 't2' => $mw_admin_auth_arr[3], 'user_type' => 'admin', 'user_id' => $mw_admin_auth_arr[4]);
...
<?php
            ...
            curl_close($handle);
            $jsondata = json_decode($result);
            $agent_reminder = $jsondata->washer_reminder;

//echo count($agent_reminder);
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE HEADER-->
                     <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase" style="font-size: 15px !important;">Reminder Washer</span>
...
<?php } ?>
                                <div class="portlet-body form">
                                    ...
                                    <form action="" method="post" class="form-horizontal form-bordered">
                                        <div class="form-body">
                                        <?php if($agent_reminder): ?>
                                        <?php foreach($agent_reminder as $ind => $creminder): ?>
            ...
            $(function(){
                counter = 1;
                counter = "<?php echo count($agent_reminder); ?>";
