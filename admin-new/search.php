...
if (($_GET['search_area'] == 'Order Number') || ($_GET['search_area'] == 'Created Date') || ($_GET['search_area'] == 'Scheduled Date') || ($_GET['search_area'] == 'On-Demand') || ($_GET['search_area'] == 'Scheduled'))
    $url = ROOT_URL . '/api/index.php?r=site/searchorders';
if (($_GET['search_area'] == 'Customer Name') || ($_GET['search_area'] == 'Customer Email') || ($_GET['search_area'] == 'Customer Phone'))
    $url = ROOT_URL . '/api/index.php?r=customers/searchcustomers';
if (($_GET['search_area'] == 'Washer Badge') || ($_GET['search_area'] == 'Washer Name') || ($_GET['search_area'] == 'Washer Phone'))
                ...
                <div class="portlet light bordered">
                    ...
                    <?php if ((($_GET['search_area'] == 'Customer Name') || ($_GET['search_area'] == 'Customer Email') || ($_GET['search_area'] == 'Customer Phone')) && (count($searchresults->allcustomers) > 0)): ?>
                        ...
                        <div class='custom-pagination'>
                            ...
                            if ($page_number != 1)
                                echo "<a href='" . ROOT_URL . "/admin-new/search.php?q=" . $_GET['q'] . "&search_area=" . $_GET['search_area'] . "&page_number=1'>&laquo;</a> ";
                            ...
                            if ($page_number != $searchresults->total_pages)
                                echo "<a href='" . ROOT_URL . "/admin-new/search.php?q=" . $_GET['q'] . "&search_area=" . $_GET['search_area'] . "&page_number=" . $searchresults->total_pages . "'>&raquo;</a> ";
                            ?>
                        </div>
                    <?php endif; ?>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($searchresults->wash_requests as $ind => $order) {
                                        ...
                                        <tr class="odd gradeX <?php if ($ind == 0) echo "flashro"; ?>" id="order-<?php echo $order->id; ?>">
                                            ...
                                            <td><?php
                                                if (APP_ENV == 'real')
                                                    $bt_link = "https://www.braintreegateway.com/merchants/" . MERCHANT_ID_REAL . "/transactions/" . $order->transaction_id;
                                                else
                                                    $bt_link = "https://sandbox.braintreegateway.com/merchants/" . MERCHANT_ID . "/transactions/" . $order->transaction_id;
                                                ?><a href="<?php echo $bt_link; ?>" target="_blank"><?php echo $order->transaction_id; ?></a></td>
                                            <td><?php
                                                if (APP_ENV == 'real')
                                                    $bt_link = "https://www.braintreegateway.com/merchants/" . MERCHANT_ID_REAL . "/transactions/" . $order->failed_transaction_id;
                                                else
                                                    $bt_link = "https://sandbox.braintreegateway.com/merchants/" . MERCHANT_ID . "/transactions/" . $order->failed_transaction_id;
                                                ?><a href="<?php echo $bt_link; ?>" target="_blank"><?php echo $order->failed_transaction_id; ?></a></td>
                                          ...
                                          if(count($order->agent_details)) echo $order->agent_details->agent_id;
                                            ...
                                            <td><?php
                                                if (count($order->agent_details))
                                                    echo "<a target='_blank' href='/admin-new/all-orders.php?agent_id=" . $order->agent_details->agent_id . "'>" . $order->agent_details->agent_name . "</a>";
                                                else
                                                    echo "N/A";
                                                ?>
                                            </td>
