                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <a style="margin-left: 20px;" class="csv-link" href="javascript:void(0)">Download CSV</a>
                        </div>
                        <div class="caption font-dark">
                    ...
                    <div class="portlet-body">
                        <p style="margin-bottom: 20px; font-size: 16px;" class="hidden">Limit Orders <select class='order-limit'><option value="200" <?php if ($_GET['limit'] == 200) echo "selected"; ?>>200</option><option value="400" <?php if ($_GET['limit'] == 400) echo "selected"; ?>>400</option><option value="600" <?php if ($_GET['limit'] == 600) echo "selected"; ?>>600</option><option value="800" <?php if ($_GET['limit'] == 800) echo "selected"; ?>>800</option><option value="1000" <?php if ($_GET['limit'] == 1000) echo "selected"; ?>>1000</option><option value="0" <?php if (!$_GET['limit']) echo "selected"; ?>>none</option></select><span class="pull-right">Android Order <?php echo $android_count; ?></span></p>
