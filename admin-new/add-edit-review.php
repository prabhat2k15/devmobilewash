...
if($_GET['action'] != 'add' && !isset($_POST['add-review-submit'])){
	...
	$review_code = $jsondata->result;
	$all_reviews = $jsondata->reviews;
	/* echo"<pre>";print_r($all_reviews[0]->cust_review);echo"</pre>";die; */
}
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
														...
														<form action="" id="add-review" method="post" enctype="multipart/form-data">
															<div class="form-group">
																...
																<input type="hidden" name="old_img" value="<?php if(!empty($all_reviews[0]->cust_img)){ echo $all_reviews[0]->cust_img;}?>">
															</div>
															<div class="form-group">
																<label class="control-label">Review</label>
																<textarea cols="10" class="form-control" rows="5" name="customer-review" id="customer-review"><?php if(isset($all_reviews[0]->cust_review)){ echo $all_reviews[0]->cust_review;}?></textarea>
															</div>
															...
															<div class="margiv-top-10">
																...
																<input type="hidden" name="action" value="<?php if(isset($all_reviews[0]->id)){echo"edit";}else{echo"add";}?>">
															</div>
														</form>
