                   ...
                   <!-- <h3 class="page-title"> New User Profile | Account
                    ...
                    <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                    <div class="form-body" style="padding: 10px 0px 0px 20px;">
                                                     ...
                                                     if($response == 'Email already exists.') echo "<p style='padding: 10px; background: red; color: #fff;'>Email already exists</p>";
                                                     else echo "<p style='padding: 10px; background: red; color: #fff;'>".$response."</p>";
                                                    } ?>
