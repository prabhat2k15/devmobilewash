...
$handle = curl_init(ROOT_URL."/api/index.php?r=users/edituser");
        $data = array("id" => $_GET['id'], "username"=>$_POST['username'], "password"=>$_POST['pass'], "usertype"=>$_POST['usertype'], 'key' => API_KEY, 'api_token' => $finalusertoken, 't1' => $mw_admin_auth_arr[2], 't2' => $mw_admin_auth_arr[3], 'user_type' => 'admin', 'user_id' => $mw_admin_auth_arr[4]);
