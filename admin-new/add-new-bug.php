...
if (isset($_POST['submit'])) {
    $data = array('platform' => $_POST['platform'], 'status' => $_POST['status'], 'description' => $_POST['description'], 'key' => API_KEY, 'api_token' => $finalusertoken, 't1' => $mw_admin_auth_arr[2], 't2' => $mw_admin_auth_arr[3], 'user_type' => 'admin', 'user_id' => $mw_admin_auth_arr[4]);
