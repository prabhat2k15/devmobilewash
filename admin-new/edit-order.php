...
//echo "<input type='hidden' name='fifth_discs[]' value='".$veh_detail[10]."' />";
            ...
            <!--<p style="margin-bottom: 10px; color: red;">#<?php //echo $log->agent_company_id;                                                                                 ?> dropped order at <?php //echo date('F j, Y - h:i A', strtotime($log->action_date));                                                                                 ?>. Reason: <?php //echo $log->addi_detail;                                                                                 ?></p>-->
                                                                    ...
                                                                    <?php endif; ?>
                                                                    <?php if ($log->action == 'Officecall'): ?>
                                                                        <p style="margin-bottom: 10px;">#<?php echo $log->agent_company_id; ?> called office at <?php echo date('F j, Y - h:i A', strtotime($log->action_date)); ?></p>
                                                                    <?php endif; ?>
...
"Customer No Response (fee)": function () {
  if(confirm('Are you sure you want to apply CNR fee to this order?')){
...
<?php endif; ?>
                                            ...
                                            if (log.action == 'Officecall') {
                                                contents += "<p style='margin-bottom: 10px;'>#" + log.agent_company_id + " called office at " + log.formatted_action_date + "</p>";
                                            }
