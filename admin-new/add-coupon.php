                            ...
                            <div class="profile-content">
                                        ...
                                        <div class="portlet light ">
                                            <div class="portlet-title tabbable-line">
                                                <div class="caption caption-md">
                                                    ...
                                                    <span class="caption-subject font-blue-madison bold uppercase">Add Coupon</span>
                                                </div>
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="coupon_name" class="form-control" value="" required /> </div>
                                                            </div>
                                                            </div>
                                                            <div class="row">
                                                            <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="coupon_code" class="form-control" value="" required /> </div>
                                                             </div>
                                                             </div>
                                                             <div class="row">
								<div class="col-md-2 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="discount_express" value="0" required />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2 col-sm-12">
                                                                <div class="form-group">
                                                                    <label class="control-label">Discount Deluxe<span style="color: red;">*</span></label>
                                                                    <input type="text" class="form-control" name="discount_deluxe" value="5" required />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="discount_premium" value="10" required />
                                                                </div>
                                                            </div>
                                                            </div>
                                                            <div class="row">
...
<div class="form-group">
                                                                ...
                                                                <option value="single">1 time use only</option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control form-control-inline date-picker" type="text" required="" placeholder="format: YYYY-MM-DD" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" name="expire_date" value="" />
                                                            </div>
                                                              </div>
                                                              </div>
                                                            ...
                                                            <div class="margiv-top-10">
                                                                <input type="submit" value="Add Coupon" name="addcoupon-form-submit" style="color: rgb(255, 255, 255); background-color: rgb(50, 197, 210); border: 1px solid rgb(50, 197, 210); padding: 6px 7px 7px 6px; border-radius: 3px;" />
                                                            </div>
                                                             </div>
                                                             </div>
                                                            <div class="clear" style="height: 10px;">&nbsp;</div>
