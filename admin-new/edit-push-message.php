...
include('header.php');
    if(!empty($_POST['hidden']))
    {
       ...
       $id = $_POST['id'];
            ...
            $data = array('id'=> $id, 'message'=> $message, 'key' => API_KEY, 'api_token' => $finalusertoken, 't1' => $mw_admin_auth_arr[2], 't2' => $mw_admin_auth_arr[3], 'user_type' => 'admin', 'user_id' => $mw_admin_auth_arr[4]);
