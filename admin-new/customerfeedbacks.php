                                ...
                                <div class="portlet-body">
                                    <div class="row">
                                        <div class="col-md-5 col-md-offset-3">
                                            <a href="<?php echo ROOT_URL;?>/admin-new/customerfeedbacks.php?type=Praise" class="btn btn-primary">PRAISE</a>
                                            <a href="<?php echo ROOT_URL;?>/admin-new/customerfeedbacks.php?type=Questions" class="btn btn-primary">QUESTIONS</a>
                                            <a href="<?php echo ROOT_URL;?>/admin-new/customerfeedbacks.php?type=Suggestion" class="btn btn-primary">SUGGESTION</a>
                                            <a href="<?php echo ROOT_URL;?>/admin-new/customerfeedbacks.php?type=Problem" class="btn btn-primary">PROBLEM</a>
                                        </div>
                                    </div>
