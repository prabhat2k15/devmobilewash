...
<?php
        ...
        /*$id = $_GET['id'];
        $url = 'http://www.mobilewash.com/dev/api/index.php?r=site/getcmsdataadmin&id='.$id; 
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                     <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase" style="font-size: 15px !important;">Reminder Agent</span><?php } ?>
                                    ...
                                    <form action="" method="post" class="form-horizontal form-bordered">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="washer_reminder"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Remind Client</label>
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="client_reminder"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
