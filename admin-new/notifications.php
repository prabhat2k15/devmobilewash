...
if (isset($_POST['notify-form-submit'])) {
    ...
    if (($_POST['receiver_type'] == 'single-client') || ($_POST['receiver_type'] == 'single-agent')) {
        ...
        $data = array("msg" => $_POST['notify_msg'], "receiver_type" => $_POST['receiver_type'], 'user_id' => $_POST['user_id'], 'key' => API_KEY, 'api_token' => $finalusertoken, 't1' => $mw_admin_auth_arr[2], 't2' => $mw_admin_auth_arr[3], 'user_type' => 'admin', 'user_id_security' => $mw_admin_auth_arr[4]);
    ...
    <div class="page-content">
        ...
        <div class="caption">
            ...
            <?php if (isset($_POST['notify-form-submit']) && $result_code == 'true'): ?>
                <p class="success" style="background: #33A232; color: #fff; padding: 10px; box-sizing: border-box;"><i class="icon-check" style="margin-right: 10px; vertical-align: middle;"></i><?php echo "Notification sent successfully"; ?></p>
            <?php endif; ?>
                        ...
                        <form action="" method="post" class="form-horizontal form-bordered">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <textarea class="form-control" data-emojiable="true" name="notify_msg" rows="5" required></textarea>
