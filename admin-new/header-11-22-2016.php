...
$userdata = array("mw_uid"=>$uid);
$handle_data = curl_init("https://www.mobilewash.com/dev/api/index.php?r=users/checkpermission");
...
$handle = curl_init("https://www.mobilewash.com/api/index.php?r=users/authenticate");
...
header("Location: https://www.mobilewash.com/admin-new/login.php");
die();
}
...
$device_token = $_COOKIE["mw_admin_auth"];
$data = array("device_token"=>$device_token);
$handle = curl_init("https://www.mobilewash.com/api/index.php?r=users/logout");
curl_setopt($handle, CURLOPT_POST, true);
curl_setopt($handle, CURLOPT_POSTFIELDS, $data);
curl_setopt($handle,CURLOPT_RETURNTRANSFER,1);
$result = curl_exec($handle);
...
$.getJSON("https://www.mobilewash.com/api/index.php?r=users/Appstat", function( data ) {
