...
$vehdata = array("id"=> $_GET['id'], "make"=>$_POST['make'], "model"=>$_POST['model'], "type"=>$_POST['type'], "cat"=>$_POST['cat'], "build"=>$_POST['build'], 'key' => 'Tva4hwH9KvqEQHTz5nHZTLhAV7Bv68AAtBeAHMA4');
...
$vehdata = array("id"=> $_GET['id'], 'build'=> $_GET['build'], 'key' => 'Tva4hwH9KvqEQHTz5nHZTLhAV7Bv68AAtBeAHMA4');
